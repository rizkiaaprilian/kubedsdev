<div class="row column">
	<div class="sop-header row">
		<h3 class="text-center">Sanding System (Prep)</h3>
		<div class="body">
			<div class="row">
				...
				<div class="medium-4 column">
					<ul class="no-bullet">
						<li><span>Carbo # 99308</span>- Preppers 6" Soft Density Backup</li>
						<li><span>Tork # 192479</span>- Specialist Wipes</li>
						<li><span>Norton</span>- 800 Rotolla roll</li>
						<li><span>Norton</span>- Primer Prep Red Scuff Pads</li>
						<li><span>Norton</span>- 400 grit Sheet Roll</li>
					</ul>
				</div>
				<div class="medium-4 column">
					<ul class="no-bullet">
						<li><span>Norton</span>- Color Prep Gray Scuff Pads</li>
						<li><span>Norton</span>- 400 Grit 6" DA Sand Paper</li>
						<li><span>Norton</span>- 600 Grit 6" DA Sand Paper</li>
						<li><span>Norton</span>- 220 Grit 6" DA Sand Paper</li>
						<li><span>Norton</span>- 320 Grit 6" DA Sand Paper</li>
					</ul>
				</div>
				<div class="medium-2 column">
		...
		<div class="row">
			<div class="medium-6 column">
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('paint_shop/02-01.jpg')?></div>
					</div>
				...
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('paint_shop/02-02.jpg')?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
				...
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('paint_shop/02-03.jpg')?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
				...
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('paint_shop/02-04.jpg')?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
				...
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('paint_shop/02-05.jpg')?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
				...
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('paint_shop/02-06.jpg')?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
			...
			<div class="medium-6 column">
				...
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('paint_shop/02-07.jpg')?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
							...
							<p>(May use Red Thin Flex Scuff Pad as alternate)</p>
						</div>
					</div>
				</div>
				<div class="row step">
				...
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('paint_shop/02-info.jpg')?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
							<p>General Rule of sanding steps:</p>
							<ul>
								<li>Do not jump more that 100 grits between steps from 80 to 400</li>
								<li>Preppers on a DA use: soft pad + 3/32 finish sander</li>
								<li>Hand sand with 100 grit finer than DA sand for similar scratch or a used piece of 400 Grit</li>
							</ul>
						</div>
					</div>
				</div>
