			...
			<div class="row">
				...
				<div class="medium-4 column">
					<ul class="no-bullet">
						...
						<li><span>Norton # 70735</span>- 13mm Foam Aperture</li>
						<li><span>3M #26334</span>- 3/4" Masking Tape</li>
						<li><span>3M #26654</span>- 1-1/2" Masking Tape</li>
				...
				<div class="medium-4 column">
					<ul class="no-bullet">
						...
						<li><span>Norton</span>- 18" White Masking Paper</li>
		...
		<div class="row">
			<div class="medium-6 column">
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('paint_shop/01-01.jpg');?></div>
					</div>
				...
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('paint_shop/01-02.jpg');?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
				...
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('paint_shop/01-03.jpg');?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
							<ul>
								<li>Outline repair area with 3/4" masking tape</li>
								<li>Use Trim Masking Tape to lift and mask gaskets, moldings, etc.</li>
								<li>Use fine line to mask emblems and any other accessories</li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="medium-6 column">
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('paint_shop/01-04.jpg');?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
				...
				<div class="row step">
					<div class="medium-4 column">
						Step #5
						<div class="border"><?=\Asset::img('paint_shop/01-05.jpg');?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
							...
							<ul>
								<li>Cut sheeting around repair area</li>
								<li>Tape sheeting down onto 1-1/2" masking tape</li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('paint_shop/01-06.jpg');?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
				...
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('paint_shop/01-info.jpg');?></div>
					</div>
					<div class="medium-8 column">
						<div class="border qr">
							...
							<div class="row column">
								...
								<?=\Asset::img('paint_shop/01-qr.jpg', array('class' => 'float-right'));?>
							</div>
						</div>
					</div>
				</div>
