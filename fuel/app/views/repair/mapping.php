<div class="column">
	...
	<p>Keep in mind, mapping is the start of an accurate repair – accuracy counts!</p>
	<p>NOTE: As a reminder, some insurance companies require that initial photographs must be taken prior to mapping the vehicle!</p>
	<hr>
	<h4>Visual Mapping Circle Codes</h4>
	<div class="text-center"><?=\Asset::img('circle-codes.png', array('alt' => 'Circle Codes'));?></div>
</div>