<div class="row column">
	<div class="body-shop-sop-header row">
		<h3 class="text-center">Truck Bed Seam Sealing</h3>
		<div class="body">
			<div class="row">
				...
				<div class="medium-4 column">
					<ul class="no-bullet">
						...
						<li><span>Norton/Carbo</span>- Red Scuff Pad</li>
		...
		<div class="row">
			<div class="medium-6 column">
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('body_shop/07-01.jpg')?></div>
					</div>
				...
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('body_shop/07-02.jpg')?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
				...
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('body_shop/07-03.jpg')?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
				...
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('body_shop/07-04.jpg')?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
				...
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('body_shop/07-05.jpg')?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
			...
			<div class="medium-6 column">
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('body_shop/07-06.jpg')?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
							<p>Apply 123EZ Seam Sealer to the seam</p>
							<ul>
								<li>The gap between the masking tape should be completely covered with sealer slightly over the tape edge firmly wet contacted to bed wall.</li>
							</ul>
						</div>
					</div>
				</div>
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('body_shop/07-07.jpg')?></div>
					</div>
					<div class="medium-8 column">
						<div class="border">
				...
				<div class="row step">
					...
					<div class="medium-2 column">
						<div class="border"><?=\Asset::img('body_shop/07-info.jpg')?></div>
					</div>
					<div class="medium-8 column">
						<div class="border qr">
							...
							<div class="row column">
								<div class="float-left">
									QR Code:<br>
									Seam Sealing Video<br>
								</div>
								<?=\Asset::img('body_shop/07-qr.jpg', array('class' => 'float-right'));?>
							</div>
						</div>
					</div>
				</div>
